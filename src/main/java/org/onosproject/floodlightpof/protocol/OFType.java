...
import org.onosproject.floodlightpof.sp.protocol.SPAtMod;
import org.onosproject.floodlightpof.sp.protocol.SPCreate;
import org.onosproject.floodlightpof.sp.protocol.SPStMod;
...
public enum OFType {
    ...
    SP_CREATE(50, OFMessage.class, new SPCreateInstantiable()),

    SP_ST_MOD(51, OFMessage.class, new STModInstantiable()),

    SP_AT_MOD(52, OFMessage.class, new ATModInstantiable());
    ...
    public static class SPCreateInstantiable implements Instantiable<OFMessage> {
        @Override
        public OFMessage instantiate() {
            return new SPCreate();
        } }

    public static class STModInstantiable implements Instantiable<OFMessage> {
        @Override
        public OFMessage instantiate() {
            return new SPStMod();
        } }

    public static class ATModInstantiable implements Instantiable<OFMessage> {
        @Override
        public OFMessage instantiate() {
            return new SPAtMod();
        } }
