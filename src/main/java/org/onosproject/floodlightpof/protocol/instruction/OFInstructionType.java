...
public enum OFInstructionType {
    ...
    GOTO_SP(12, OFInstructionGotoSP.class, new OFInstructionGotoSPInstantiable()),
    ...
    static class OFInstructionGotoSPInstantiable implements Instantiable<OFInstruction> {
        @Override
        public OFInstruction instantiate() {
            return new OFInstructionGotoSP();
        } }
